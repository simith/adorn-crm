import { IChatItem } from "./components/ChatItem";
...
export const chatsData: IChatItem[] = [
    {
        ...
        messages: [
            ...
            { message: "I'm doing well, thanks! How about you?", sendAt: "04:33 PM", sender: "me", status: "read" },
            { message: "Just finished a great book. Have any recommendations?", sendAt: "04:34 PM", sender: "other" },
            { message: "That's awesome! I'd recommend 'The Silent Observer.'", sendAt: "04:36 PM", sender: "me", status: "read" },
            { message: "Thanks! I'll check it out.", sendAt: "04:37 PM", sender: "other" },
            { message: "Did you catch the latest movie? It's fantastic!", sendAt: "04:38 PM", sender: "me", status: "delivered" },
            { message: "No, I haven't. What's the title?", sendAt: "04:40 PM", sender: "other" },
            { message: "It's called 'Dreamscape.' A must-watch!", sendAt: "04:42 PM", sender: "me", status: "sent" },
            { message: "Sounds intriguing. I'll add it to my watchlist.", sendAt: "04:44 PM", sender: "other" },
            { message: "Great! Let me know what you think after watching.", sendAt: "04:46 PM", sender: "me", status: "read" },
        ],
    },
    {
        id: 2,
